...
function wpgmza_pro_return_category_checkbox_list($map_id,$show_all = true,$array = false) {
    ...
    foreach ( $results as $result ) {
        $ret_msg .= "<div class='wpgmza_cat_checkbox_item_holder'><input type='checkbox' class='wpgmza_checkbox' id='wpgmza_cat_checkbox_".$result->id."' name='wpgmza_cat_checkbox$array_suffix' mid=\"".$map_id."\" value=\"".$result->id."\" /><label for='wpgmza_cat_checkbox_".$result->id."'>".$result->category_name."</label></div>";
    }    
        $ret_msg .= "</div>";
