...
<?php
SrizonFlickrUI::BoxHeader( 'box-search', __( "Embed Albums from other users", 'srizon-flickr-gallery' ), true );
?>
    <form action="admin.php?page=SrzFlickr-OtherAlbums" method="post">
        <table class="srzflickr-admin-common" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="submit" class="button-primary" name="searchUser" value="<?php _e( 'Search Albums', 'srizon-flickr-gallery' ); ?>">
                </td>
            </tr>
        </table>
    </form>
